...
);isc.B._maxIndex=isc.C+1;isc.A=isc.Class;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$cj={};isc.A.dontDup={StringBuffer:true,Action:true,MathFunction:true,JSONEncoder:true};isc.A.evalFrameResetInterval=100;isc.A.evalFrameDefaults={doEval:function(_1,_2){this.evalCount++;return this.getHandle().doEval(_1,_2)}};isc.A.evalFrameHTML=["<html><body><script>"+"var nativeObjTypes = ['Array', 'String', 'Date'];","for (var i = 0; i < nativeObjTypes.length; i++) {"+"var proto = window[nativeObjTypes[i]].prototype,"+"sourceProto = window.parent[nativeObjTypes[i]].prototype;"+"for (var attr in sourceProto) {"+"proto[attr] = sourceProto[attr];"+"}"+"}"+"window.isc = window.parent.isc;"+"function doEval(exp, args) {"+"try{"+"if (args) {"+"with (args) { "+"return eval(exp);"+"}"+"} else {"+"return eval(exp);"+"}"+"} catch (e) {"+"window.parent.isc.Log.logInfo("+"'Attempt to evaluate in eval-frame threw error:' + e "+"+ '. Attempting eval in main window.',"+"'iframeEval');"+"if (args) {"+"with (args) { "+"return window.parent.eval(exp);"+"}"+"} else {"+"return window.parent.eval(exp);"+"}"+"}"+"}"+"</script></body></html>"];isc.A.$ck={};isc.A.fireOnPauseDelay=200;isc.A.$cl="$cm";isc.A.$cn={};isc.A.$co={};isc.A.useFastEvalWithVars=isc.Browser.isMoz&&isc.Browser.geckoVersion>=20061010;isc.A.$cp="ID";isc.A.getWindow=(isc.Browser.isSafari?function(){return window}:function(){return this.ns.$ch});isc.A.getDocument=(isc.Browser.isSafari?function(){return window.document}:function(){return this.ns.$ci});isc.B.push(isc.A.create=function isc_c_Class_create(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13){var _14=this.createRaw();_14=_14.completeCreation(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13);return _14}
...
return _5}
,isc.A.evaluate=function isc_c_Class_evaluate(_1,_2,_3,_4){if(!isc.$611)isc.$611=0;isc.$611++;var _5;if(_4&&isc.Browser.isIE&&!_3&&isc.Page.isLoaded()){_5=this.evalInIFrame(_1,_2)}else{if(_2){with(_2){if(_3)_5=window.eval(_1)
else _5=eval(_1)}}else{if(_3)_5=window.eval(_1)
else _5=eval(_1)}}
if(isc.$611!=null)isc.$611--;if(isc.$611==0)delete isc.$611;return _5}
,isc.A.evalInIFrame=function isc_c_Class_evalInIFrame(_1,_2){if(this.logIsDebugEnabled("iframeEval")){this.logDebug("Using iframe for evaluation:\n"+_1,"iframeEval")}
...
if(this.evalFrame.frame==null)this.logInfo("Temporarily unable to "+"evaluate in a HiddenFrame for domain "+document.domain+"; "+"falling back to a simpler evaluate that may leak memory");return this.evalFrame.frame==null?this.evaluate(_1,_2):this.evalFrame.doEval(_1,_2)}
,isc.A.makeEvalFrame=function isc_c_Class_makeEvalFrame(){this.evalFrame=isc.HiddenFrame.create(this.evalFrameDefaults);this.$104k=document.domain;this.evalFrame.draw();if(document.domain==location.hostname&&this.evalFrame.getFrameDocument()==null)
{var _1=isc.addProperties({location:isc.Page.getURL("[HELPERS]empty.html")},this.evalFrameDefaults);this.evalFrame=isc.HiddenFrame.create(_1);this.evalFrame.draw()}}
,isc.A.resetEvalFrame=function isc_c_Class_resetEvalFrame(){if(this.logIsInfoEnabled("iframeEval")){this.logInfo("Using iframe for evaluation - resetting iframe.","iframeEval")}
this.evalFrame.evalCount=0;var _1=this.evalFrame.frame=this.evalFrame.getFrameDocument();if(_1!=null){_1.open();var _2=this.evalFrame.$104k?"document.domain = '"+this.evalFrame.$104k+"';":"";_1.write(this.evalFrameHTML[0]+_2+this.evalFrameHTML[1]);_1.close()}else{this.evalFrame.$104k=document.domain}}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.ClassFactory;isc.A.observe=isc.Class.getPrototype().observe;isc.A.ignore=isc.Class.getPrototype().ignore;isc.A.$dk=isc.Class.getPrototype().$dk;isc.A=isc.Class;isc.A.$dk=isc.Class.getPrototype().$dk;isc.eval=function(_1,_2){return isc.Class.evaluate(_1,null,false,_2)}
...
isc.$752=_19;var _20=isc.$gh,_21=isc.$506,_19=isc.$752;var _22=this;_22.compareAscending=Array.compareAscending;_22.compareDescending=Array.compareDescending;var _23=function(_32,_33){var _24=(_32!=null?_32.$gm:null),_25=(_33!=null?_33.$gm:null);for(var i=0;i<_20.length;i++){var _26=_20[i][_24],_27=_20[i][_25];if(_19&&_26!=null&&_27!=null){var _28=isc.$gi,_29=_28[i][_24],_30=_28[i][_25];if(_29!==_16&&_30!==_16){_26=_29;_27=_30}}
var _31=(_21[i]?_22.compareAscending(_26,_27):_22.compareDescending(_26,_27));if(_31!=0)return _31;else if(_19){if((_29!==_16)!=(_30!==_16)){return(_29!==_16)==!!_21[i]?-1:1}}}
...
,isc.A.$kz=function isc_c_EventHandler___handleMouseMove(_1,_2){var _3=this;var _4;if(isc.Browser.isIE){var _5=_3.$j6,_6=_2.buttonNum;if(_5){if(_6==0){_4=true}}else if(_6==1&&_2.eventType==_3.MOUSE_MOVE){if(_3.$94x){}else{_2.eventType=_3.MOUSE_DOWN;_3.handleMouseDown(null,_2);_2.eventType=_3.MOUSE_MOVE}}}
...
,isc.A.handleMouseUp=function isc_c_EventHandler_handleMouseUp(_1,_2){if(isc.Browser.isTouch&&!_2)return;var _3=isc.EH;if(isc.Browser.isIE&&!_3.$j6){if(_3.$94x)return;var _4=_3.lastEvent;_4.eventType=_3.MOUSE_DOWN;_3.handleMouseDown(null,_3.lastEvent)}
_3.$94x=_2;if(!_2)_3.$ku=true;var _5=_3.$k5(_1,_2);_3.$ku=false;if(isc.Browser.isSafari)_5=true;return _5}
...
,isc.A.$77r=function isc_c_EventHandler__handleTouchEnd(_1){var _2=isc.EH;_2.DOMevent=_1;var _3=_2.getMouseEventProperties(_1);if(this.$94y==_2.$94w.TOUCH_STARTED){this.$94y=_2.$94w.TOUCH_COMPLETE}
...
if(_2.$78m!=null)isc.Timer.clear(_2.$78m)}
,isc.A.$86w=function isc_c_EventHandler__handleTouchCancel(_1){var _2=isc.EH;_2.DOMevent=_1;var _3=_2.getMouseEventProperties(_1);if(this.$94y==_2.$94w.TOUCH_STARTED){this.$94y=_2.$94w.TOUCH_COMPLETE}
...
if(this.$86n!=null&&this.$86n!=this.getScrollLeft()){_2=true;_3=this.$86n}
...
_18[58]=this.getTransformCSS();_18[60]=_6;var _19=64;if(this.$kk()&&this._useNativeTabIndex&&this.clipHandleIsFocusHandle){_18[64]=_2.$ry;_18[65]=this.$qn();_18[66]=_2.$rz;_18[67]=this.$qo();if(!this.isDisabled()){_18[68]=_2.$r0;isc.$bk(_18,this.getTabIndex(),69,5);if(this.accessKey!=null){_18[74]=_2.$r1;_18[75]=this.accessKey;_19=76}else _19=74;if(!this.showFocusOutline){if(!_2.$sa)_2.$sa=" hideFocus=true";_18[_19]=_2.$sa;_19+=1}}else _19=68}
if((this.ariaRole||this.ariaState)&&isc.Canvas.ariaEnabled()&&!isc.Canvas.useLiteAria())
{if(this.ariaRole){_18[_19++]=" role='";_18[_19++]=this.ariaRole;_18[_19++]="' "}
if(this.ariaState){_18[_19++]=this.getAriaStateAttributes()}}
...
);isc.evalBoundary;isc.B.push(isc.A.$s2=function isc_Canvas__offscreenChildrenHeight(){if(!isc.isAn.Array(this.children))return 0;var _1=0;for(var i=0;i<this.children.length;i++){var _3=this.children[i],_4=(_3.position==isc.Canvas.ABSOLUTE?_3.getTop():_3.getOffsetTop());if(_4<_1)_1=_4}
return-_1}
...
);isc.evalBoundary;isc.B.push(isc.A.getVSnapOrigin=function isc_Canvas_getVSnapOrigin(_1){return this.VSnapOrigin?this.VSnapOrigin:0}
...
var _12=this.getHMarginBorder(),_13=this.getVMarginBorder();var _14=Math.max((_6+_12),this.getWidth()),_15=Math.max((_7+_13),this.getHeight());if(isc.Menu&&isc.isA.Menu(this.parentElement)&&isc.isA.GridBody(this)&&(_14>this.getWidth()||_15>this.getHeight())){this.$t5=true}
this.$q5(this.left,this.top,_14,_15);var _16=this.children&&this.children.length>0;if(!_16||this.allowContentAndChildren){var _17=this.getScrollHeight(true),_18=this.getScrollWidth(true);if(_17!=_7||_18!=_6){_6=_18;_7=_17;this.$q5(this.left,this.top,Math.max((_6+_12),this.getWidth()),Math.max((_7+_13),this.getHeight()))}}
...
if(this.scrollLeft!=0||this.scrollTop!=0)this.$51s()}else if(this.overflow==_5.CLIP_H){var _7=this.getScrollHeight(),_13=this.getVMarginBorder(),_19=Math.max(_7+_13,this.getHeight());this.$uz=_19;this.setClip(0,this.getWidth(),_19,0);this.$q5(this.left,this.top,this.getWidth(),_19)}else if(this.overflow==_5.CLIP_V){var _6=this.getScrollWidth(),_12=this.getHMarginBorder();if((isc.Browser.isIE||isc.Browser.isMoz||isc.Browser.isOpera)&&(_6>this.getInnerWidth())&&(this.$uy==_6)){this.$q5(this.left,this.top,this.getWidth(),this.getHeight());_6=this.getScrollWidth(true)
...
var _20=Math.max(_6+_12,this.getWidth());this.setClip(0,_20,this.getHeight(),0);this.$uy=_20}else{if(isc.Browser.isIE&&this.showCustomScrollbars&&this.getScrollingMechanism()==isc.Canvas.NATIVE)
{var _21=this.scrollLeft,_22=this.scrollTop;if(this.getScrollLeft()!=_21||this.getScrollTop()!=_22){this.$lh()}}
var _23=this.vscrollOn,_24=this.hscrollOn,_25=this.$kk();var _26=(this.alwaysShowVScrollbar&&this.showCustomScrollbars);if(this.overflow==isc.Canvas.SCROLL){this.hscrollOn=this.vscrollOn=true}else{var _7=this.getScrollHeight(),_27=this.getHeight(),_6=this.getScrollWidth(),_28=this.getWidth(),_29=this.getScrollbarSize(),_30;var _13=this.getVMarginBorder(),_12=this.getHMarginBorder();if(!this.showCustomScrollbars&&this.getHandle().clientHeight!=null){this.hscrollOn=(this.getClipHandle().clientHeight<_27-_13);this.vscrollOn=_26||(this.getClipHandle().clientWidth<_28-_12)}else{this.vscrollOn=_26||((_7-(_27-_13))>0);this.hscrollOn=(_6-(_28-_12))>0}
if((this.vscrollOn&&!_23&&!this.hscrollOn)||(this.hscrollOn&&!_24&&!this.vscrollOn))
{if(this.showCustomScrollbars){this.$q5(this.left,this.top,this.getWidth(),this.getHeight())}
_30=(this.vscrollOn?"V":"")+(this.hscrollOn?"H":"");this.innerSizeChanged("introducing scrolling");var _18=this.getScrollWidth(true),_17=this.getScrollHeight(true);if(this.logIsDebugEnabled("scrolling")){this.logDebug("Rechecking scrollWidth/Height on introduction of scroll:"+" old: "+[_6,_7]+", new: "+[_18,_17],"scrolling")}
_6=_18;_7=_17}
if(this.vscrollOn&&!this.hscrollOn){if(this.showCustomScrollbars||(this.getClipHandle().clientHeight==null))
this.hscrollOn=_6-(_28-_12-_29)>0;else
this.hscrollOn=(_27>this.getClipHandle().clientHeight+this.getVBorderSize())}else if(this.hscrollOn){if(this.showCustomScrollbars||(this.getClipHandle().clientWidth==null))
this.vscrollOn=_26||(_7-(_27-_13-_29)>0);else
this.vscrollOn=_26||(_28>this.getClipHandle().clientWidth+this.getHBorderSize())}}
...
if(this.showCustomScrollbars&&(this.hscrollOn!=_24||this.vscrollOn!=_23))
{this.$q5(this.left,this.top,this.getWidth(),this.getHeight());if(this.$su!=null)delete this.$su;if(this.$sz!=null)delete this.$sz}
var _31=((_23?"V":"")+(_24?"H":"")),_32=((this.vscrollOn?"V":"")+(this.hscrollOn?"H":""));if(_31!=_32){this.logInfo("Scrollbar state: "+_31+" -> "+_32,"scrolling");if(_30==null||_32!=_30)
{this.innerSizeChanged("scrolling state changed")}}
if(this.isRTL()&&this.hscrollOn&&!_24){var _33=this.getClipHandle().scrollLeft;this.scrollLeft=_33}
if(this.showCustomScrollbars){if(!this.hscrollOn&&_24)this.hscrollbar.hide();if(!this.vscrollOn&&_23)this.vscrollbar.hide();if(this.hscrollOn){this.$u1()}else{if(_24)this.scrollTo(0,null,"ending hscroll")}
if(this.vscrollOn){this.$u2()}else{if(_23)this.scrollTo(null,0,"ending vscroll")}
this.$51s()}
if((this._useNativeTabIndex||this._useFocusProxy)&&_25!=this.$kk())
{this.$ur()}}
return true}
...
);isc.evalBoundary;isc.B.push(isc.A.$u4=function isc_Canvas__scrollByAmount(_1,_2,_3){if(_1){this.scrollTo(null,this.getScrollTop()+_2,_3)}else{this.scrollTo(this.getScrollLeft()+_2,_3)}}
...
);isc.evalBoundary;isc.B.push(isc.A.opacityChanged=function isc_Canvas_opacityChanged(_1,_2){}
...
);isc.B._maxIndex=isc.C+544;isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$hm="[SKIN]";isc.A.printOmitControls=["Button","StretchImgButton","ImgButton","MenuButton","Toolbar","ToolStrip","ButtonItem","ToolbarItem"];isc.A.printIncludeControls=["Label"];isc.A.$ws=0;isc.A.$94t="&apos;";isc.A.$wt="ID='";isc.A.$ob="'";isc.A.$wu="absmiddle";isc.A.$wv=[,,," eventpart='valueicon' style='vertical-align:middle;margin-left:",,"px;margin-right:",,"px;'"];isc.A.$ww={};isc.A.$wx={png:true,PNG:true,Png:true};isc.A.$wy=["<a",," href='",,"' target='",,"'",,,,">",,"</a>"];isc.A.$wz="[SKINIMG]/blank.gif";isc.A.$w0="0";isc.A.$w1="clearRedrawQueue";isc.A.$65j=[];isc.A.$65k=0;isc.A.$65l="clearDestroyQueue";isc.A.$tw=[];isc.B.push(isc.A.stripScriptTags=function isc_c_Canvas_stripScriptTags(_1){return _1.replace(/<script([^>]*)?>(.|\n|\r)*?<\/script>/ig,isc.emptyString)}
...
var _12=this.getImgURL(_1,_6,_8);if(_9)_11=[this.$xe];if(isc.Page.isXHTML()){_12=isc.makeXMLSafe(_12)}else{_12=_12.replace(this.$ob,this.$94t)}
if(isc.screenReader){if(_5==null||!isc.contains(_5,"alt=")){_11[0]="<img role='presentation' src='"}else{_11[0]=this.$xe}}
...
);isc.B._maxIndex=isc.C+4;isc.defineClass("ScreenSpan","Canvas");isc.A=isc.ScreenSpan.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A._generated=true;isc.A.$94z=3200;isc.A.$940=2400;isc.A.src="[SKINIMG]/blank.gif";isc.A.redrawOnResize=false;isc.A.overflow="hidden";isc.B.push(isc.A.getInnerHTML=function isc_ScreenSpan_getInnerHTML(){if(!this.$yy){this.$yy=isc.Browser.isIE&&isc.Browser.version>6?isc.Canvas.imgHTML(this.src,this.$94z,this.$940):isc.Canvas.spacerHTML(this.$94z,this.$940)}
return this.$yy}
...
,isc.A.$63j=function isc_Canvas__setupHilites(_1,_2){if(_1!=null){this.$63k=this.$63k||0;var _3={},_4=[];for(var i=0;i<_1.length;i++){var _6=_1[i].id
if(_6!=null){if(_3[_6]){this.logWarn("This component has more than one hilite object with "+"the same specified id:"+_6+". Hilite IDs must be unique within a component.","hiliting")}else{_3[_6]=true;var _7=parseInt(_6);if(_6==_7){this.$63k=Math.max(this.$63k,(_7+1))}}}else{_4.add(_1[i])}}
for(var i=0;i<_4.length;i++){_4[i].id=this.$63k++}
this.$58b=_1.makeIndex("id",-1)}
if(!_2)this.applyHilites()}
,isc.A.applyHilites=function isc_Canvas_applyHilites(_1){var _2=this.hilites,_3=this.data;if(_2&&!this.$58b)this.$63j(_2,true);if(isc.isA.ResultSet(_3))_3=_3.getAllLoadedRows();if(isc.isA.Tree(_3))_3=_3.getAllItems();_3.setProperty(this.hiliteMarker,null);var _4=this.getAllFields();if(_4&&_4.length>0){for(var i=0;i<_4.length;i++){var _6=_4[i],_7=_6[this.fieldIdProperty];if(_6.userFormula||_6.userSummary){if(_6.userSummary&&!_6.$652)
...
,isc.A.applyHilite=function isc_Canvas_applyHilite(_1,_2,_3){_1=this.getHilite(_1);if(!_1.criteria)return;if(_1.disabled)return;var _3=_3||_1.fieldName;if(_3==null)_3=this.fields?this.fields.getProperty("name"):[];var _4=[],_5=this.getDataSource();if(_5){var _6=_5.dropUnknownCriteria;_5.dropUnknownCriteria=false;_4=_5.applyFilter(_2,_1.criteria);_5.dropUnknownCriteria=_6}else{_4=this.unboundApplyFilter(_2,_1.criteria)}
var _7=isc.isAn.Array(_3)?_3:[_3];if(this.logIsDebugEnabled("hiliting")){this.logDebug("applying filter: "+this.echoFull(_1.criteria)+", produced matches: "+isc.echoLeaf(_4)+", on fields: "+_7,"hiliting")}
for(var j=0;j<_7.length;j++){var _9=this.getField(_7[j]);for(var i=0;i<_4.length;i++){var _11=_4[i];this.hiliteRecord(_11,_9,_1)}}}
...
);isc.evalBoundary;isc.B.push(isc.A.disableHilite=function isc_Canvas_disableHilite(_1){this.enableHilite(_1,false)}
...
var _11={rawValue:_2,dateFormatter:_5};return _11}
...
);isc.evalBoundary;isc.B.push(isc.A.handleAsyncValidationReply=function isc_Canvas_handleAsyncValidationReply(_1,_2){}
,isc.A.isPendingAsyncValidation=function isc_Canvas_isPendingAsyncValidation(){return!isc.isAn.emptyObject(this.$75a)}
...
return null}
,isc.A.createLocatorFallbackPath=function isc_c_AutoTest_createLocatorFallbackPath(_1,_2){var _3=[];for(var _4 in _2){var _5=_2[_4];if(isc.isA.String(_5)){_5=_5.replace(/\//g,this.slashMarker);_5=escape(_5)}
...
_7=unescape(_7);_7=_7.replace(new RegExp(this.slashMarker,"g"),"/");_5[_9]=_7}
...
if(isc.DynamicForm){isc.DynamicForm.addProperties({getInteriorLocator:function(_50){var _66=isc.DynamicForm.$mu(_50,this);if(!_66.item)return this.Super("getInteriorLocator",arguments);var _61=_66.item,_67=[this.getItemLocator(_61),'/'];if(_66.overElement)_67[_67.length]="element";else if(_66.overTitle)_67[_67.length]="title";else if(_66.overTextBox)_67[_67.length]="textbox";else if(_66.overControlTable)_67[_67.length]="controltable";else if(_66.overInlineError)_67[_67.length]="inlineerror";else if(_66.overIcon)_67[_67.length]="[icon='"+_66.overIcon+"']"
