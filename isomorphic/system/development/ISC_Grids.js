...
,isc.A.cacheSelection=function isc_Selection_cacheSelection(){if(this.$89z||this.$890||this.$925)return;this.$27q=[];var _1=this.getItemList(),_2=isc.isA.ResultSet!=null&&isc.isA.ResultSet(_1),_3=_1.getLength();if(_2&&!_1.lengthIsKnown()){this.$q7=false;return}
...
,isc.A.$22k=function isc_GridRenderer__getCellValue(_1,_2,_3){var _4=this.getCellValue(_1,_2,_3,this);if(!this.isPrinting&&this.$80g(_1)){var _5=this.$667(_1);if(_5.allWithin){if(_5.extraHeight&&(_5.extraHeight>this.cellHeight)){_4=[_4,this.$80q,isc.Canvas.spacerHTML(1,_5.extraHeight-
Math.max(isc.ListGrid.getInstanceProperty("cellHeight"),this.cellHeight)),this.$80r].join(isc.emptyString)}}else if(_5.extraHeight&&_5.extraHeight>0){_4=[_4,this.$80q,isc.Canvas.spacerHTML(1,_5.extraHeight),this.$80r].join(isc.emptyString)}}else if(_1&&_1.$29a!=null){var _6=_1.$29a||[];for(var i=0;i<_6.length;i++){var _8=_1.$29a[i];if(_8==null)continue;if(_8.$57n!=_3)continue;var _9=(_8.embeddedPosition==this.$57l);var _10=_8.$80t;if(_10!=null){_4+=_9?this.$80q+_10+this.$80r:_10;delete _8.$80t}}}
return _4}
...
);isc.evalBoundary;isc.B.push(isc.A.getTotalRows=function isc_GridRenderer_getTotalRows(){return this.totalRows}
...
);isc.evalBoundary;isc.B.push(isc.A.getHSnapPosition=function isc_GridRenderer_getHSnapPosition(_1,_2){if(!this.snapToCells){return this.Super("getHSnapPosition",arguments)}
...
,isc.A.$29y=function isc_GridBody__rowClick(_1,_2){if(!this.grid)return;var _3;var _4=this.grid.getFieldNumFromLocal(_2,this);var _5=this.grid.getField(_4),_6=false;if(_5&&_5.isRemoveField){var _7=this.grid.getRecord(_1);if(!_7||!_7.$52e){_6=true}}
if(_6){this.grid.removeRecordClick(_1,_2);_3=false}else{_3=this.Super("$29y",arguments)}
return _3}
...
,isc.A.mouseUp=function isc_GridBody_mouseUp(){var _1=isc.EH.getTarget();if(this.grid&&_1!=null&&_1!=this&&this.grid.$30a){var _2=this.grid.getEditForm();while(_1!=this&&_1!=null&&_1!=_2){if(_1.canvasItem&&_2.items.contains(_1.canvasItem)){return}
...
,isc.A.recordMarkedAsRemoved=function isc_ListGrid_recordMarkedAsRemoved(_1){if(_1==null)return false;if(!isc.isA.Number(_1)){_1=this.getEditSessionRowNum(_1);if(_1==null)return false}
return(this.getEditValue(_1,this.recordRemovedProperty)==true)}
...
{var _9={disabled:true,showHover:true,prompt:this.selection.selectionRangeNotLoadedMessage,title:(this.canSelectAll==false||this.selectionType=="single")?"&nbsp;":this.getValueIconHTML(_8.replace(".","_Disabled."),_5)}
this.setFieldProperties(_7,_9)}else{var _9={disabled:false,showHover:false,prompt:null,title:(this.canSelectAll==false||this.selectionType=="single")?"&nbsp;":this.getValueIconHTML(_8,_5)}
...
_17.iconSize=this.removeIconSize}
...
if(!this.$922)this.defaultFieldState=this.getFieldState()}
...
,isc.A.refreshFields=function isc_ListGrid_refreshFields(){this.$922=true;this.setFields(this.completeFields);delete this.$922}
...
if(_4)return;var _7=[];for(var i=0;i<this.fields.length;i++){if(_1.contains(this.fields[i])){_7[i]=this.getDefaultFieldWidth(this.fields[i])}}
return _7}
,isc.A.getDefaultFieldWidth=function isc_ListGrid_getDefaultFieldWidth(_1){if(_1.type=="icon"&&(_1.iconWidth!=null||_1.iconSize!=null)){return(_1.iconWidth||_1.iconSize)+2*this.cellPadding+2*this.iconPadding}else if(this.showValueIconOnly(_1)){return this.getValueIconWidth(_1)+(2*this.cellPadding)+this.getValueIconRightPadding(_1)+this.getValueIconLeftPadding(_1)}
...
var _4;if(this.recordMarkedAsRemoved(_2)&&this.removedCSSText){_4=this.removedCSSText}else{if(this.isEditable()){if(this.editFailedBaseStyle==null&&this.editFailedCSSText&&this.cellHasErrors(_2,_3))
...
var _8=this.fields[_3],_9=null;if(_8==null)return"";if(this.$94m&&_8.summaryValue){return _8.summaryValue}
...
,isc.A.getSpecifiedFieldWidth=function isc_ListGrid_getSpecifiedFieldWidth(_1){var _2=this.getField(_1);if(_2==null){if(isc.isAn.Object(_1))_1=_1[this.fieldIdProperty];_2=this.getSpecifiedField(_1)}
...
if(_5.contains(_8.valueField)||_5.contains(_8.displayField)){this.$92x=true}}
if(this.$92x){var _11=true;for(var i=0;i<this.$45o.length;i++){var _1=this.$45o[i];if(!_1.$68q){_11=false;break}}
if(_11){this.regroup(true);delete this.$92x}}}
...
if(this.isGrouped){return this.data.getRange(0,this.groupByMaxRecords)}else{return this.data.getRange(_1[0],_1[1]+1)}}
return null}
...
return this.Super("$315",arguments)},$94m:true})}else{this.summaryRow.setDataSource(this.getSummaryRowDataSource(),this.completeFields.duplicate());this.summaryRow.$855()}
...
if((_4.userFormula||_4.userSummary)&&_4.canEdit==null)return false;return true}
...
);isc.evalBoundary;isc.B.push(isc.A.startEditing=function isc_ListGrid_startEditing(_1,_2,_3,_4,_5){if(!this.canEdit&&!(this.completeFields||this.fields).getProperty("canEdit").or()){this.canEdit=true}
...
return _2}
,isc.A.$74c=function isc_ListGrid__remapEmbeddedComponents(){if(!this.body||this.body.$29a==null)return;var _1=this.body.$29a,_2=[];this.$74a=0;for(var i=0;i<_1.length;i++){var _4=_1[i],_5=_4.embeddedRecord,_6=this.getPrimaryKeys(_5),_7=this.findRowNum(_6),_8;if(_7>=0){_8=this.data.get(_7);if(!_8.$29a)_8.$29a=[];if(!_8.$29a.contains(_4)){_4.$289=_7;_4.embeddedRecord=_8;_8.$29a.add(_4);if(_4.isExpansionComponent){if(this.$74a<this.maxExpandedRecords){this.$74a++;_8.expanded=true
_8.hasExpansionComponent=true;if(!this.canExpandMultipleRecords)this.$74b=_8}else{_2.add(_4);continue}}}}else{if(this.$74d==false||(this.showRecordComponents&&this.recordComponentPoolingMode=="data")||(_4.isExpansionComponent)){_2.add(_4)}}}
if(_2.length>0){for(var i=0;i<_2.length;i++){var _9=_2[i];if(this.canExpandRecords){if(this.$74b&&this.$74b==_9.embeddedRecord)
delete this.$74b}
...
);isc.evalBoundary;isc.B.push(isc.A.getColumnLeft=function isc_ListGrid_getColumnLeft(_1){var _2=this.getFieldBody(_1);return _2.getColumnLeft(this.getLocalFieldNum(_1))}
...
);isc.evalBoundary;isc.B.push(isc.A.getGroupByText=function isc_ListGrid_getGroupByText(_1){var _2={field:_1,title:this.getSummaryTitle(_1),viewer:this}
...
this.$73p=_7;var _13=this.$73p[0],_14=_13?_13.property:null,_15=_14?this.getFieldNum(_14):null,_16=_14?this.getUnderlyingField(_14):null,_17=_13?Array.shouldSortAscending(_13.direction):null;if(!_16){if(_13)this.logWarn("Field does not exist: "+_13.property)}
if(_15>=0){this.$600(_15)}else{this.$600(null)}
...
this.data.setSort(this.$73p)}else if(this.data.sortByProperty){if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort - Calling data.sortByProperty with specifier:\n"+isc.echoAll(_13),"sorting")}
this.data.sortByProperty(_13.property,Array.shouldSortAscending(_13.direction),_13.normalizer,_13.context)}}else{if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort - not sorting:\nthis.data is"+this.echoAll(this.data),"sorting")}}}else{if(this.data){if(this.data.setSort!=null)this.data.setSort([]);else if(this.data.unsort)this.data.unsort()}
if(this.invalidateCacheOnUnsort){this.invalidateCache()}}
var _18=(this.header&&isc.isA.Toolbar(this.header));if(_2){if(_2.length>0){if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort - Removing sort-media from now unsorted fields:\n"+isc.echoAll(_2),"sorting")}}
for(var i=0;i<_2.length;i++){var _19=_2[i],_9=this.getSpecifiedField(_19.property),_20=[];if(_9){_20.add(_9);if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort, removing sort-media for fieldName '"+_9.name+"'","sorting")}}
var _12=this.getFields();if(_12){var _21=_12.findAll("displayField",_19.property);if(_21){_21.removeUnless("optionDataSource",null);if(_21.length>0){_20.addList(_21);if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort, removing sort-media for fields with displayField "+"'"+_9.name+"' - these are: "+isc.echoFull(_21.getProperty("name").join(", ")),"sorting")}}}}
for(var j=0;j<_20.length;j++){var _23=_20[j],_24=this.getFieldNum(_23.name);if(_23){_23.sortDirection=_23.originalSortDirection}
if(_24>=0&&_18){var _25=this.getFieldHeaderButton(_24);if(_25)_25.setTitle(_25.getTitle())}}}}
if(this.$73p&&this.$73p.length>0){this.logInfo("In setSort - Setting sort-media for sorted fields:\n"+isc.echoAll(this.$73p),"sorting");var _26=false;for(var i=0;i<this.$73p.length;i++){var _19=this.$73p[i],_9=this.getSpecifiedField(_19.property),_20=[];if(_9){_20.add(_9);if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort, adding sort-media for fieldName '"+_9.name+"'","sorting")}}
var _12=this.getFields();if(_12){var _21=_12.findAll("displayField",_19.property);if(_21){_20.addList(_21);if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort, adding sort-media for fields with displayField "+"'"+_9.name+"' - these are: "+isc.echoFull(_21.getProperty("name").join(", ")),"sorting")}}}
for(var j=0;j<_20.length;j++){var _23=_20[j],_24=this.getFieldNum(_23.name);if(_23){if(_23.sortDirection&&!_23.originalSortDirection){_23.originalSortDirection=_23.sortDirection}
_23.sortDirection=_19.direction}
if(_18&&_24>=0){var _27=this.getFieldHeader(_24),_25=this.getFieldHeaderButton(_24);if(_25){if(!_26){_27.selectButton(_25);_26=true}
_25.setTitle(this.getHeaderButtonTitle(_25))}}}}}else if(_18){var _28;if(this.header){_28=this.header.getSelectedButton();if(_28)_28.deselect()}
if(this.frozenHeader){_28=this.frozenHeader.getSelectedButton();if(_28)_28.deselect()}}
if(_15>=0){if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort - $600 called with fieldNum: "+_15+" - sortField is now: "+this.sortField+"\ngetSortState() now returns: "+isc.echoAll(this.getSortState()),"sorting")}}
if(this.sorter){this.sorter.setTitle(this.sorter.getTitle())}
...
,isc.A.getGroupNodeHTML=function isc_ListGrid_getGroupNodeHTML(_1,_2){var _3=this.frozenBody===_2;if(this.frozenBody&&!_3&&this.singleCellGroupHeaders()){return this.emptyCellValue}
var _4=this.data.isOpen(_1)?"opened":"closed",_5=isc.Img.urlForState(this.groupIcon,null,null,_4),_6=isc.Canvas.spacerHTML(this.groupIconPadding,1),_7=isc.Canvas.spacerHTML((this.data.getLevel(_1)-1)*this.groupIndentSize+this.groupLeadingIndent,1);var _8=this.imgHTML(_5,this.groupIconSize,this.groupIconSize);var _9=(this.canCollapseGroup?_7+_8+_6+this.getGroupTitle(_1):_7+_6+this.getGroupTitle(_1));return _9}
...
);isc.evalBoundary;isc.B.push(isc.A.applyGroupSummaryToHeader=function isc_ListGrid_applyGroupSummaryToHeader(_1){var _2=_1.groupName;if(this.groupByFieldSummaries!=null&&!this.groupByFieldSummaries.contains(_2)){return}
...
this.markForRedraw("refresh group summaries")}}else{var _5;if(_1!=null)_5=this.groupTree.getLength();this.groupTree.$736();if(_1==null||(_5!=this.groupTree.getLength())){if(this.body!=null)this.body.markForRedraw("refresh group summaries")}else{var _6=this.groupTree.getParent(this.groupTree.get(_1));if(_6){var _7=this.groupTree.indexOf(_6),_8=this.groupTree.getChildren(_6);for(var i=0;i<_8.length;i++){if(_8[i].isGroupSummary)this.refreshRow(_7+1+i)}}}}}
...
this.Super(this.$oc);if(!this.fields){this.$51r=true;this.fields=[];var _4=(this.submenuDirection==this.$oz);if(_4&&this.showSubmenus)this.fields.add(isc.Menu.SUBMENU_FIELD);if(this.showIcons)this.fields.add(isc.Menu.ICON_FIELD);this.fields.add(isc.Menu.TITLE_FIELD);if(this.showKeys)this.fields.add(isc.Menu.KEY_FIELD);if(!_4&&this.showSubmenus)this.fields.add(isc.Menu.SUBMENU_FIELD)}else{this.$51r=false;for(var i=0;i<this.fields.length;i++){var _6=this.fields[i];if(isc.isA.String(_6)){if(isc.Menu.standardFields[_6]!=null){this.fields[i]=isc.Menu[isc.Menu.standardFields[_6]]}else{this.logWarn("Menu field specified as :"+_6+". This is not a recognized standard field name");this.fields.removeAt(i);i-=1}}}}
...
return false}
,isc.A.setData=function isc_Menu_setData(_1,_2,_3,_4){var _5;if(isc.Tree&&isc.isA.Tree(_1)){this.setTreeData(_1,true)}else{_5=this.invokeSuper(isc.Menu,"setData",_1,_2,_3,_4)}
delete this.$35y;return _5}
...
,isc.A.$58t=function isc_TileLayout__getSpacerCanvas(){if(!this.$58u){this.$58u=isc.Canvas.create({autoDraw:false,width:1,height:1});this.addChild(this.$58u)}
return this.$58u}
...
return _4}
,isc.A.generateFunction=function isc_c_FormulaBuilder_generateFunction(_1,_2,_3,_4,_5){if(_5==null)_5=true;var _6=isc.SB.create(),_7=_1.text,_8=this.getFieldIdProperty(_3),_9=this.getFieldDetailsFromValue(_1.formulaVars,_2,_3),_10=_9.usedFields,_11=_9.missingFields;_10=_10.sortByProperties(["mappingKey"],[false],[function(_14,_20,_21){var _12=_14[_20];if(_12.length==1)_12='  '+_12;else if(_12.length==2)_12=' '+_12;return _12}]);if(_11.length==0){if(_10.length>0){for(var i=0;i<_10.length;i++){var _14=_10.get(i);var _15=_14[_8];_6.append("var ");_6.append(_14.mappingKey,"=isc.DataSource.getPathValue(record,'",_15,"');","\nif(",_14.mappingKey,"==null)",_14.mappingKey,"= (component && component.getStandaloneFieldValue ? component.getStandaloneFieldValue(record, '",_15,"', true) : "+(_4?"null)":"0)"));_6.append(";\n");if(_1.allowEscapedKeys){_7=_7.replaceAll("#"+_14.mappingKey,_14.mappingKey);_7=_7.replaceAll("#{"+_14.mappingKey+"}",_14.mappingKey)}}
_6.append("\n")}
var _16=isc.MathFunction.getRegisteredFunctions();if(_16&&_16.length>0){_6.append("var functions=isc.MathFunction.getRegisteredFunctionIndex(),\n");for(var i=0;i<_16.length;i++){var _14=_16.get(i);_6.append("        ");_6.append(_14.name,"=","functions.",_14.name,".jsFunction");_6.append(i==_16.length-1?";":",","\n")}
_6.append("\n")}
if(_5){_6.append("try{\n")}
_6.append("var value=",_7,";");if(_5){var _17="Attempt to evaluate formulaFunction \""+_7+"\" failed. Error message:";_6.append("\n} catch (e) { (component||isc).logWarn('",_17,"' + e.message)}\n")}
_6.append((_4?null:"if (isNaN(value)) return (component && component.badFormulaResultValue) || '.'; "),"return value;")}else{this.logWarn("Formula failed due to missing fields: "+_11.join(", ")+".");var _12=(_3&&_3.badFormulaResultValue)||".";if(_12)_12="'"+_12+"'";_6.append("return ",_12,";")}
var _18=_6.toString();var _19;if(_5){try{_19=new Function("record,component",_18)}catch(e){this.logWarn("Error attempting to convert formula text '"+_7+"' to a function:"+e.message);_19=new Function("record,component","return null;")}}else{_19=new Function("record,component",_18)}
return _19}
