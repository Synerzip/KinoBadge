...
isc.ClassFactory.defineClass("DynamicForm","Canvas","DataBoundComponent");isc.addGlobal("FormLayout",isc.DynamicForm);isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.GET="GET";isc.A.POST="POST";isc.A.NORMAL="normal";isc.A.MULTIPART="multipart";isc.A.NORMAL_ENCODING="application/x-www-form-urlencoded";isc.A.MULTIPART_ENCODING="multipart/form-data";isc.A.$89="$89";isc.A.$9a="$9a";isc.A.$9b="$9b";isc.A.$9c="$9d";isc.A.$9e="$9f";isc.A.$99r="inlineErrorHandle";isc.A.$9g="$9g";isc.B.push(isc.A.buildOperatorIndex=function isc_c_DynamicForm_buildOperatorIndex(){if(isc.DataSource==null)return;var _1=isc.getValues(isc.DataSource.getSearchOperators());_1=_1.sortByProperties(["symbol"],[false],[function(_4,_5,_6){var _2=_4[_5],_3=isc.isA.String(_2)?_2.length:0;return _3}]);this.$85l=_1.makeIndex("symbol",true)}
...
if(_5.$11s(_1))return;_5=this.$11t(_5,_1);if(_5!=null){this.focusInItem(_5,_1)}else{if(isc.EH.$kj==this&&isc.EH.$kl==this){this.focusAtEnd(_1)}else{return this.Super("$kf",arguments)}}}
...
,isc.A.$148=function isc_FormItem__getEventMaskHTML(){var _1=this.$13n;_1[1]=this.$149();_1[3]=this.getHeight();_1[5]=this.getItemID();_1[7]=this.$qs("eventMask");_1[9]=this.$938();return _1.join(isc.emptyString)}
,isc.A.$938=function isc_FormItem__getEventMaskSpacerHTML(){return(isc.Browser.isIE?isc.Canvas.spacerHTML(1600,100):"&nbsp;")}
...
,isc.A.getReadOnlyHTML=function isc_FormItem_getReadOnlyHTML(_1,_2){return this.getElementHTML(_1,_2)}
...
return _8}
,isc.A.$99s=function isc_FormItem__getInlineErrorHandleAttributes(){if(this.$99t==null){this.$99t=isc.SB.concat("ID='",this.$qs('inlineErrorHandle'),"' ",isc.DynamicForm.$89,"='",this.getID(),"' ",isc.DynamicForm.$9a,"='",isc.DynamicForm.$99r,"' ")}
return this.$99t}
,isc.A.getInlineErrorHandle=function isc_FormItem_getInlineErrorHandle(){return isc.Element.get(this.$qs('inlineErrorHandle'))}
...
return}}
if(_2){this.$93l=true;this.focusInItem()}}
...
,isc.A.mapValueToDisplay=function isc_FormItem_mapValueToDisplay(_1){var _2=this.canEscapeHTML&&(this.escapeHTML||this.outputAsHTML||this.asHTML);var _3=this.$17b(_1);_3=this.$17c(_3);if(_2&&(_1==null||_1==isc.emptyString)&&_3==this.$54t)
{_2=false}
...
if(_1==null)_1=this.emptyDisplayValue;return _1}
...
this.$43d=_4}}
);isc.evalBoundary;isc.B.push(isc.A.getOptions=function isc_FormItem_getOptions(){return this.getValueMap()}
...
,isc.A.$66s=function isc_FormItem__hideInFieldHint(_1){if(this.$66u){var _2=this.getDataElement();if(_2){_2.className=this.getTextBoxStyle();if(this.$857){_2.type=this.$857;delete this.$857}}else{var _3=this.$15h();if(_3!=null){_3.className=this.getTextBoxStyle()}}
if(!_1)this.setElementValue(isc.emptyString);this.$66u=false}}
...
{this.redraw()}
for(var _17 in _7){if(_17!=this.name){this.form.setFieldErrors(_17,_7[_17],true)}}
...
);isc.evalBoundary;isc.B.push(isc.A.$wb=function isc_FormItem__handleHover(_1){if(this.itemHover&&this.itemHover(this,this.form)==false)return false;var _2;if(this.itemHoverHTML)_2=this.itemHoverHTML(this,this.form);else _2=this.form.itemHoverHTML(this,this.form);this.form.$119(this,_2)}
...
,isc.A.isDisabled=function isc_FormItem_isDisabled(){if(this.form==null)return this.disabled;var _1=this.disabled;if(!_1){if(this.parentItem!=null)_1=this.parentItem.isDisabled();else{_1=this.form.isDisabled();if(!_1&&this.containerWidget!=this.form)_1=this.containerWidget.isDisabled()}}
return _1}
...
var _4=this.selectOnFocus;if(_4==null&&this.form)_4=this.form.selectOnFocus;if(this.$93l)_4=false;if(_4&&_2.select)_2.select()}
...
,isc.A.$12v=function isc_FormItem__nativeElementFocus(_1,_2){if(this.$93l)delete this.$93l;if(isc.EH.$lg==this)delete isc.EH.$lg
...
,isc.A.$43g=function isc_FormItem__handleInput(){isc.EH.$h1("INP");this.$105w();isc.EH.$h2()}
,isc.A.$105w=function isc_FormItem___handleInput(){if(!this.mask){if(this.changeOnKeypress){if(isc.Log.supportsOnError){this.updateValue()}else{try{this.updateValue()}catch(e){isc.Log.$am(e)}}}else if(this.hasDataElement()&&this.length!=null){var _1=this.getElementValue();if(isc.isA.String(_1)&&_1.length>this.length){this.setElementValue(_1.substring(0,this.length))}}}}
...
return _3}
_2.handleKeyUp=function(_8,_9){var _3;if(this.keyUp!=null){_3=this.keyUp(_8,_9)}
if(this.canvasItem){var _4=this.canvasItem.handleKeyUp(_8,_9);if(_4==false)_3=false}
return _3}
...
,isc.A.canvasResized=function isc_CanvasItem_canvasResized(_1,_2,_3){if(this.$181)return;var _4=this.canvas,_5=_4.getWidth(),_6=_4.getHeight();if(!_4.isDrawn())return;if(_3!="overflow"&&_3!="Overflow on initial draw"){if(_1!=null&&_1!=0)_4.$pn=_5;if(_2!=null&&_2!=0)_4.$po=_6}
...
return _1}
,isc.A.$12v=function isc_TextItem__nativeElementFocus(_1,_2){var _3=this.$93l;var _4=this.Super("$12v",arguments);this.$66s();if(this.formatOnFocusChange)this.refreshDisplayValue()
...
,isc.A.filterComplete=function isc_SelectItem_filterComplete(){if(this.allowEmptyValue&&!this.multiple&&this.$19m()){var _1=this.pickList.data.addEmptyValueRecord(this.getValueFieldName());if(_1&&this.pickListVisible())this.pickList.markForRedraw()}
var _2=isc.PickList.getPrototype().filterComplete;_2.apply(this,arguments)}
...
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("StaticTextItem","FormItem");isc.A=isc.StaticTextItem.getPrototype();isc.A.height=null;isc.A.width=null;isc.A.wrap=true;isc.A.textBoxStyle="staticTextItem";isc.A.redrawOnShowIcon=false;isc.A.useShortDateFormat=false;isc.A.canEscapeHTML=true;isc.A.escapeHTML=null;isc.A.emptyDisplayValue="&nbsp;";isc.A=isc.StaticTextItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.isEditable=function isc_StaticTextItem_isEditable(){return false}
,isc.A.$kk=function isc_StaticTextItem__canFocus(){if(this.canFocus!=null)return this.canFocus;return isc.screenReader}
);isc.B._maxIndex=isc.C+2;isc.ClassFactory.defineClass("LinkItem","TextItem");isc.A=isc.LinkItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.disableIconsOnReadOnly=false;isc.A.wrap=false;isc.A.height=null;isc.A.canEdit=false;isc.A.readOnlyTextBoxStyle="staticTextItem";isc.B.push(isc.A.shouldApplyStaticTypeFormat=function isc_LinkItem_shouldApplyStaticTypeFormat(){return!this.canEdit}
...
,isc.A.$94a=function isc_LinkItem__inactiveLinkClicked(_1){if(!this.inactiveEditorLinkDisabled){return this.$30i(_1)}
...
,isc.A.setValueTree=function isc_PickTreeItem_setValueTree(_1){this.valueTree=_1;this.logWarn(this.canvas);if(this.canvas){this.canvas.setData(this.valueTree)}}
,isc.A.$18y=function isc_PickTreeItem__createCanvas(){var _1={getTitle:isc.PickTreeItem.$21k,canFocus:this.$kk(),disabled:this.isDisabled(),dataSource:this.getOptionDataSource(),criteria:this.optionCriteria,data:this.valueTree,canSelectParentItems:this.canSelectParentItems,itemSelected:isc.PickTreeItem.$21j,emptyMenuMessage:this.emptyMenuMessage,loadDataOnDemand:this.loadDataOnDemand,treeDataLoaded:isc.PickTreeItem.$21l,displayField:this.displayField};if(_1.width==null&&this.width!=null){var _2=this.getInnerWidth();_1.width=_2}
this.canvas=this.addAutoChild("button",_1,this.buttonConstructor,this.container);this.autoDestroy=true;this.Super("$18y",arguments);if(this._value!=null)this.setValue(this._value)}
,isc.A.$21j=function isc_PickTreeItem__itemSelected(_1){var _2=this.$21m(_1);this.$93r=_1;var _3=this.$10y(_2);if(_3==false)delete this.$93r;if(this.getValue()!=_2)_3=false;return _3}
,isc.A.saveValue=function isc_PickTreeItem_saveValue(_1,_2){if(this.$93r!=null){this.$21n=this.$93r;delete this.$93r}else{this.$21n=this.$21s(_1);if(this.canvas){this.canvas.setSelectedItem(this.$21n)}}
return this.Super("saveValue",arguments)}
...
_2.invalidateCache()}
);isc.B._maxIndex=isc.C+17;isc.defineClass("IPickTreeItem","PickTreeItem");isc.A=isc.IPickTreeItem.getPrototype();isc.A.buttonConstructor="ITreeMenuButton"}
...
if(_13.formValuesChanged&&isc.isA.Function(_13.formValuesChanged))
_13.formValuesChanged()}
if(_2){this.$709(_1)}}}
...
,isc.A.setThumb=function isc_RecordScrollbar_setThumb(){if(!this.$210)return;if(this.isDrawn()&&this.thumb.isDrawn())this.thumb.moveAbove(this);var _1=this.trackSize();if(this.data!=null&&this.data.getLength()>0){_1=_1/ this.data.getLength();_1=Math.max(this.thumbMinSize,Math.round(_1))}
...
,isc.A.updateForm=function isc_MultiRecordForm_updateForm(){if(this.data==null)return;var _1=this.$212.getCurrentPosition();this._form.setData(this.data.get(_1))}
...
this.data=_1;this.observe(this.data,"dataChanged","observer.updateForm()");this.$212.setData(_1);this.showRecord(this.initialRecord);this.updateForm()}
,isc.A.showRecord=function isc_MultiRecordForm_showRecord(_1){if(isc.isA.Number(_1)){this.$212.setPosition(_1)}else{this.$212.setPosition(this.data.indexOf(_1))}}
,isc.A.$211=function isc_MultiRecordForm__createForm(){return isc.DynamicForm.create({ID:this.getID()+"_form",autoDraw:false,overflow:"auto",height:"100%",dataSource:this.dataSource},this.formProperties)}
,isc.A.$213=function isc_MultiRecordForm__createScrollBar(){return isc.RecordScrollbar.create({ID:this.getID()+"$214",autoDraw:false,width:16,height:"100%",data:this.data,position:this.initialRecord})}
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("MultiView","VLayout");isc.A=isc.MultiView.getPrototype();isc.A.$215={};isc.A.views=["ListGrid","TileGrid"];isc.A.ListGridDefaults={_constructor:"ListGrid",name:"ListGrid"};isc.A.TileGridDefaults={_constructor:"TileGrid",name:"TileGrid"};isc.A.CalendarDefaults={_constructor:"Calendar",name:"Calendar"};isc.A.DetailViewerDefaults={_constructor:"DetailViewer",name:"DetailViewer"};isc.A.TreeGridDefaults={_constructor:"TreeGrid",name:"TreeGrid"};isc.A.currentView="ListGrid";isc.A.showFilterEditor=true;isc.A.autoFetchData=true;isc.A.dbcDefaults={showPanelHeader:true,tileWidth:100,tileHeight:150};isc.A.dbcProperties={};isc.A=isc.MultiView.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function isc_MultiView_initWidget(){this.Super(this.$oc);this.dataSource=isc.DataSource.getDataSource(this.dataSource);this.setShowFilter(this.showFilter);this.setCurrentView(this.currentView,true)}
,isc.A.setDataSource=function isc_MultiView_setDataSource(_1,_2){this.dataSource=isc.DS.getDataSource(_1);for(var _3 in this.$215){var _4=this.$215[_3];_4.setDataSource(this.dataSource,_2);_4.title=_4.dataSource?_4.dataSource.ID:""}
...
,isc.A.bindToDataSource=function isc_MultiView_bindToDataSource(_1,_2){for(var _3 in this.$215){this.$215[_3].bindToDataSource(_1,_2)}}
...
,isc.A.createFilter=function isc_MultiView_createFilter(){this.filterForm=isc.AdvancedFilter.create({ID:this.getID()+"$wo",autoDraw:false,dataSource:this.dataSource,dualMode:true,currentMode:"simple",mv:this,filter:function(_1,_2){this.Super("filter",[this.mv.currentDBC,_2])}},this.filterProperties)}
,isc.A.setCurrentView=function isc_MultiView_setCurrentView(_1,_2){if(_1==null)_1=this.currentView;this.currentView=_1;if(this.currentDBC)this.currentDBC.hide();if(_2){var _3=this.$215[_1]=this.createAutoChild(_1,this.$71z(_1));this.addSwitcher(_3)}else{this.$217(_1)}
this.currentDBC=this.$215[_1];this.addMember(this.currentDBC);this.currentDBC.show();this.showView(this.currentDBC)}
,isc.A.$71z=function isc_MultiView__getCombinedDBCProperties(_1){var _2=isc.addProperties({},this.dbcDefaults,this.dbcProperties,{dataSource:this.dataSource,title:this.title,icon:this.icon,multiView:this,showFilterEditor:this.showFilterEditor,autoFetchData:this.autoFetchData,recordClick:this.$71y});return _2}
,isc.A.$217=function isc_MultiView__initView(_1){var _2=this.getView(_1);if(!_2){var _2=this.$215[_1]=this.createAutoChild(_1,this.$71z(_1));this.addSwitcher(_2)}
...
,isc.A.getView=function isc_MultiView_getView(_1){return this.$215[_1]}
...
,isc.A.$71y=function isc_MultiView__dbcRecordClick(){var _1;if(isc.isA.ListGrid(this))_1=arguments[1];else if(isc.isA.TileGrid(this))_1=arguments[2];return this.multiView.recordClick(_1,this)}
...
,isc.A.formValuesChanged=function isc_ViewFileItem_formValuesChanged(){this.setCanvasContent(null)}
,isc.A.setValue=function isc_ViewFileItem_setValue(_1){this.setCanvasContent(_1);this.Super("setValue",arguments)}
,isc.A.setCanvasContent=function isc_ViewFileItem_setCanvasContent(_1){var _2=this.getFormRecord();if(this.type=="imageFile"&&this.showFileInline!=false){this.canvas.setHeight("*");this.canvas.setWidth("*");this.canvas.setContents(this.getImageHTML()||"&nbsp;")}else{if(this.showFileInline==true){this.logWarn("setValue(): Unsupported field-type for showFileInline: "+this.type)}
this.canvas.setHeight(20);this.canvas.setWidth("*");this.canvas.setContents(this.getViewDownloadHTML(_1,_2)||"&nbsp;")}}
...
,isc.A.setViewType=function isc_DOMView_setViewType(_1){_1=_1||this.pickForm.getValue("viewType");this.viewType=_1;this.pickForm.setValue("viewType",_1);this.setXMLText(this.textView.getValue("xmlText"));if(this.viewType=="none"){this.treeView.hide();this.textView.hide();var _2=21;this.setHeight(_2);this.$po=_2;return}
this.$po=null;if(_1=="tree"){this.textView.hide();if(this.xmlDocument){this.treeView.setRootElement(this.xmlDocument.documentElement)}
this.treeView.show()}else{this.treeView.hide();this.textView.show()}}
,isc.A.fetchXML=function isc_DOMView_fetchXML(){isc.xml.loadXML(this.getURL(),this.getID()+".$22t(xmlText)")}
,isc.A.$22t=function isc_DOMView__fetchXMLReply(_1){this.setXMLText(_1)}
...
var _5=this.urlForm.getValues();var _6=isc.DataSource.create(_5);var _7=_6.getServiceInputs({data:_2});_7.callback=this.getID()+".$22v(xmlDoc);";isc.xml.sendXMLRequest(_7)}
,isc.A.$22v=function isc_XMLBinder__sendReply(_1){this.rawResults=_1;this.displayArea.setRootElement(_1.documentElement)}
...
,isc.A.isTableElement=function isc_DOMEditor_isTableElement(){if(this.$9b==null)return false;var _1=this.$9b,_2=_1.tagName;return _2!=null&&_2.toLowerCase()=="table"}
,isc.A.getElementValue=function(fieldName){var element=this.$9b;if(element==null)return null;if(fieldName.startsWith("style.")){element=element.style;if(element==null)return null;fieldName=fieldName.substring(6)}
var oldValue;try{isc.eval("oldValue = "+this.getID()+".$9b."+fieldName+";")}catch(e){oldValue="Error: "+e.description}
return oldValue}
,isc.A.setElementValue=function(fieldName,newValue){var element=this.$9b;if(element==null)return;isc.eval("element."+fieldName+"=newValue")}
,isc.A.itemChange=function isc_DOMEditor_itemChange(_1,_2,_3){if(_1==null)return;this.saveToElement(_1.getFieldName(),_2)}
,isc.A.saveToElement=function isc_DOMEditor_saveToElement(_1,_2){var _3=this.$9b;if(_3==null)return;var _4=this.getElementValue(_1);if(_4!=_2){this.logWarn("changed "+_1+" from "+this.echoLeaf(_4)+" to "+this.echoLeaf(_2));if(_1=="innerHTML"&&isc.Browser.isIE){return this.$22x(_3,_4,_2)}
...
,isc.A.$22x=function isc_DOMEditor__replaceIEInnerHTML(_1,_2,_3){var _4=_1;while(_4!=null){var _5=_4.tagName;if(_5==null)continue;_5=_5.toLowerCase();if(_5=="div"||_5=="td")break;_4=_4.parentNode}
if(_4==null){this.logWarn("Couldn't change innerHTML, no safe parent found");return}
var _6=_4.innerHTML;_6=_6.replace(_2,_3);_4.innerHTML=_6;this.logWarn("replaced innerHTML on ancestor: "+this.echoLeaf(_4));var _7=this.inspector,_8=_7.treeGrid.data,_9=_8.find("$9b",_4);_8.reloadChildren(_9);_8.loadSubtree(_9);this.editElement(_4)}
...
,isc.A.removeSelectedElement=function isc_DOMInspector_removeSelectedElement(){var _1=this.treeGrid.getSelectedRecord();if(_1==null)return;var _2=this.treeGrid.data;var _3=_2.getParent(_1);var _4=_1.$9b;if(_4&&_4.parentNode)_4.parentNode.removeChild(_4);this.domEditor.clearValues();_2.reloadChildren(_3)}
...
if(_3&&_1!=null){if(!_6&&_1==this.quantityField){this.valueField.focusInItem()}}}
...
,isc.A.getCriterion=function isc_DateRangeItem_getCriterion(_1){if(this.validateCriteria){if(!this.validateRange())return null}
_1=_1||!this.allowRelativeDates;var _2=_1?this.fromField.getValue():this.fromField.getRelativeDate()||this.fromField.getValue(),_3=_2!=null,_4=_1?this.toField.getValue():this.toField.getRelativeDate()||this.toField.getValue(),_5=_4!=null,_6=null;if(_3||_5){_6={_constructor:"AdvancedCriteria",operator:"and",criteria:[]};if(_3){if(isc.isA.RelativeDateItem(_2)){_2.rangePosition="start"}
...
return _6}
,isc.A.validateRange=function isc_DateRangeItem_validateRange(){var _1=true;if(this.fromField&&!this.fromField.validate())_1=false;if(this.toField&&!this.toField.validate())_1=false;return _1}
...
);isc.B._maxIndex=isc.C+7;isc.A=isc.DateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.autoDestroy=true;isc.B.push(isc.A.init=function isc_DateRangeItem_init(){this.$67h();this.Super("init",arguments)}
...
);isc.B._maxIndex=isc.C+3;isc.A=isc.MiniDateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.autoValidate=true;isc.B.push(isc.A.init=function isc_MiniDateRangeItem_init(){this.addAutoChild("rangeDialog",{autoValidate:this.autoValidate,fromDate:this.fromDate,toDate:this.toDate,rangeItemProperties:{allowRelativeDates:this.allowRelativeDates,type:this.getType()},dateDisplayFormat:this.dateDisplayFormat,callback:this.getID()+".rangeDialogCallback(value)"});this.icons=[isc.addProperties({prompt:this.pickerIconPrompt},this.pickerIconDefaults,this.pickerIconProperties)];this.canTabToIcons=true;this.rangeItem=this.rangeDialog.rangeItem;this.rangeItem.name=this.name;if(this.defaultValue){this.setValue(this.defaultValue)}}
,isc.A.setAutoValidate=function isc_MiniDateRangeItem_setAutoValidate(_1){this.autoValidate=_1;if(this.rangeDialog)this.rangeDialog.autoValidate=this.autoValidate}
