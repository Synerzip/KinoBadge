...
,isc.A.getElementText=function isc_c_XMLTools_getElementText(_1){if(this.elementIsNil(_1))return null;if(!_1)return null;var _2=_1.firstChild;if(!_2){if(isc.Browser.isMoz&&_1.nodeType==2)return _1.value;return isc.emptyString}
var _3=_2.data;if(isc.Browser.isMoz&&_3!=null&&_3.length>4000)return _1.textContent;return _3}
...
_2.transport=_1.transport;if(_1.ignoreReloginMarkers)_2.ignoreReloginMarkers=true;_2.operations.add(_1);var _4=_1.data;if(_4==null)_4="__ISC_NULL__";else if(_4==="")_4="__ISC_EMPTY_STRING__";if(!_1.clientOnly)_2.requestData.operations.add(_4);if(_2.omitNullMapValuesInResponse!==false&&_1.omitNullMapValuesInResponse!=null){_2.omitNullMapValuesInResponse=_2.requestData.omitNullMapValuesInResponse=_1.omitNullMapValuesInResponse}else{_2.omitNullMapValuesInResponse=false}
...
var _3;var _4=false;if(_2.operations[0]&&_2.operations[0].allowIE9Leak!=null)
{_4=_2.operations[0].allowIE9Leak}else if(isc.RPCManager.allowIE9Leak){_4=true}
if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _5=_2.operations[0];if(_5&&_5.isRestRequest){var _6=isc.DataSource.get(_5.dataSource);if(_6){if(_5&&_5.dataFormat=="json"&&_6.jsonPrefix==null)
{_3=true}else{var _7=_2.results?_2.results.indexOf(_6.jsonPrefix):-1;_3=_7!=-1}
if(_3){var _8=_2.results;_8=this.$89n(_8,_6);try{_2.results=isc.eval("("+_8+")",(_4?false:true))}catch(e){this.logWarn("Error evaling REST RPC response: "+e+" response text: "+_8);_3=false}}}}
if(!_3){var _9=isc.isAn.Array(_2.operations)?_2.operations[0]:null;if(_9&&_9.isRestRequest&&_2.operations.length>1){if(_9.dataFormat=="json"){this.logWarn("Found a REST request that appears to be in JSON format, "+"but the response was not wrapped as configured by the jsonPrefix "+"and jsonSuffix properties - aborting")
return}else{_2.results=this.$89g(_2.results);_3=_2.results!=null}}}}
var _10=_2.results;if(_3&&!isc.isAn.Array(_10))_10=[_10];var _11=_2.operations,_12=[];_2.$66n=true;for(var i=0,j=0;i<_11.length;i++){var _5=_11[i];var _15;if(_3&&_5.clientOnly){_15=isc.addProperties(this.createRPCResponse(_2,_5),{isStructured:false})}else{_15=isc.addProperties(this.createRPCResponse(_2,_5),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_10:null,results:_3?_10[j]:_10});if(_3&&_5.isRestRequest){isc.addProperties(_15,{data:_10[j]})}
j++}
if(_15.status==null)_15.status=0;if(_15.isStructured){if(_15.results.errors){var _16=_15.results.errors;if(isc.isAn.Array(_16)&&_16.length==1){_16=_16[0]}}
if(_15.results&&!_5.isRestRequest){if(!_15.results.response){isc.addProperties(_15,_15.results)}else{isc.addProperties(_15,_15.results.response)}}}
_12[i]=_15;_2.responses[i]=_15;_2.changed()}
var _17=0;while(_17<_11.length&&!_2.suspended&&!_2.abortCallbacks)
{var _5=_11[_17],_15=_12[_17];this.performOperationReply(_5,_15);_17++}
if(_2.showPrompt)this.doClearPrompt(_2);if(!_2.suspended&&!_2.abortCallbacks){this.clearTransaction(_1)}
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _18=_5.application?_5.application:this.getDefaultApplication();if(isc.isA.String(_18))_18=window[_18];_18.fireCallback(_2.$40c,"responses",[_2.responses])}}
...
,isc.A.insertCacheData=function isc_ResultSet_insertCacheData(_1,_2,_3){if(!isc.isAn.Array(_1))_1=[_1];if(this.allRows&&this.allRows!=this.localData&&!_3){this.allRows.addListAt(_1,_2)}
var _4=this.localData;_4.addListAt(_1,_2);if(this.isPaged())this.setFullLength(this.totalRows+_1.length)}
,isc.A.addEmptyValueRecord=function isc_ResultSet_addEmptyValueRecord(_1){var _2=this.allRows,_3=this.localData,_4=this.isLocal()?_2:_3;if(!_4||_4.find(_1,null))return false;var _5=!_2||_2==_3||_2.find(_1,null),_6={};_6[_1]=null;this.insertCacheData(_6,0,_5);return true}
...
_5=_5[0]}
_1.errors=_5}else if(_1.status<0){_1.data=_4.data;_1.totalRows=_1.startRow;_1.endRow=_1.startRow}
...
if(_3==null)_3=_1.name;var _4=this.getEditorType(_1,_2.ID);var _5=_2?_2.valueType:"text",_6=isc.SimpleType.getType(_1.type)||isc.SimpleType.getType("text"),_7=[],_8;_6=_6.name;var _9={$93k:_1};isc.addProperties(_9,_1);_9.canEdit=_1.canFilter;_1=_9;_4=this.getEditorType(_1,_2.ID);if(_5=="fieldType"||_5=="custom"||_5=="valueSet"){var _10=_6;var _11=isc.addProperties({type:_10,valueType:_5,name:_1.name,showTitle:false,title:this.valueItemTitle,width:this.valueItemWidth,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3,_2.ID,"value"));if(_4)_11.editorType=_4;if(_5=="valueSet"){_11.multiple=true;_11.showHintInField=true;_11.hint=this.valueSetHint;_11.parseEditorValue=function(_17,_18,_19){if(_17==null)return _17;return _17.split(",")};_11.formatEditorValue=function(_17,_18,_19,_20){if(_17==null)return"";if(isc.isAn.Array(_17)){return _17.join(",")}
return _17}}
_11=this.combineFieldData(_11,_1);_11.name="value";if(_1.type=="enum"){_11=isc.addProperties(_11,{valueMap:_1.valueMap})}
if(_6=="boolean"){_11=isc.addProperties(_11,{showLabel:false,defaultValue:true,align:this.isRTL()?"right":"left"})}
if(_1.editorProperties){if(_1.editorType=="SelectItem"||_1.editorType=="ComboBoxItem"||_1.editorType=="select")
{_8=_1.editorProperties;if(_8.optionDataSource!=null)_11.optionDataSource=_8.optionDataSource;if(_8.valueField!=null)_11.valueField=_8.valueField;if(_8.displayField!=null)_11.displayField=_8.displayField}else{_11=isc.addProperties({},_11,_1.editorProperties)}}
_7.add(_11)}else if(_5=="fieldName"){if(_4==null){_4=this.fieldDataSource?"ComboBoxItem":"SelectItem"}
_8=isc.addProperties({},this.fieldPickerDefaults,{type:_4,showTitle:false,valueType:_5,width:this.valueItemWidth,textMatchStyle:this.fieldPicker.textMatchStyle,changed:function(){this.form.creator.valueChanged(this,this.form)}});if(this.fieldDataSource){_8=isc.addProperties(_8,{completeOnTab:true,optionDataSource:this.fieldDataSource,valueField:"name",displayField:this.showFieldTitles?"title":"name",pickListProperties:{reusePickList:function(){return false}}})}else{var _12=this.getFieldNames(true);_12.remove(_3);var _13={};for(var i=0;i<_12.length;i++){var _15=_12[i];if(this.showFieldTitles){var _16=this.getField(_15).title;_16=_16?_16:_15;_13[_15]=_16}else{_13[_15]=_15}}
_8=isc.addProperties(_8,{valueMap:_13})}
_7.add(isc.addProperties(_8,this.getValueFieldProperties(_1.type,_3,_2.ID,"name"),this.fieldPickerProperties,{name:"value"}))}else if(_5=="valueRange"){_8=this.combineFieldData(isc.addProperties({type:_6,editorType:_4,showTitle:false,width:this.valueItemWidth,changed:function(){this.form.creator.valueChanged(this,this.form)}}),_1);_7.addList([isc.addProperties({},_8,{name:"start"},this.getValueFieldProperties(_1.type,_3,_2.ID,"start")),isc.addProperties({type:"staticText",name:"rangeSeparator",showTitle:false,width:1,shouldSaveValue:false,defaultValue:this.filterBuilder?this.filterBuilder.rangeSeparator:null,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getRangeSeparatorProperties(_1.type,_3,_2.ID)),isc.addProperties({},_8,{name:"end"},this.getValueFieldProperties(_1.type,_3,_2.ID,"end"))])}
if(this.validateOnChange){for(var i=0;i<_7.length;i++){isc.addProperties(_7[i],{blur:function(_17,_18){if(!_17.creator.itemsInError)_17.creator.itemsInError=[];if(!_17.validate(null,null,true)){_18.focusInItem();if(!_17.creator.itemsInError.contains(_18)){_17.creator.itemsInError.add(_18)}}else{if(_17.creator.itemsInError.contains(_18)){_17.creator.itemsInError.remove(_18)}}}})}}
for(var i=0;i<_7.length;i++){if(_7[i].showIf!=null)delete _7[i].showIf}
return _7}
...
,isc.A.getEditorType=function isc_FilterBuilder_getEditorType(_1,_2){var _3=this.getPrimaryDS(_1);return isc.FilterBuilder.getDefaultEditorType(_1,_3,_2)}
