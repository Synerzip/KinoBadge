	...
	fields:[
        ...
        {name:"inStock", width:55, align:"center",
            formatCellValue : function (value, record, field, rowNum, colNum) {
                if (value) return isc.Canvas.imgHTML(13,13);
                else return isc.Canvas.imgHTML(13,13)
            }},
...
isc.TabSet.create({
	ID:"itemDetailTabs",
	tabs:[
		{title:"View", pane:itemViewer, ID:"viewTab", width:70 },
		{title:"Edit", pane:editForm, ID:"editTab", width:70 }
	],
